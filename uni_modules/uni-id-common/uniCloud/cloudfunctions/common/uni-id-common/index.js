...
class m {
  ...
  async getUserPermission() {
    ...
    if (e.includes("admin"))
      return (
        (this.userPermission = { role: e, permission: [] }), this.userPermission
      );
    ...
    var i;
    return (
      (this.userPermission = { role: e, permission: n }), this.userPermission
    );
  }
...
var E = Object.freeze({
  ...
  createToken: async function ({ uid: e, role: t, permission: n } = {}) {
    return new m({ uniId: this }).createToken({
      uid: e,
      role: t,
      permission: n,
    });
...
class x {
  ...
  _getPlatformConfig() {
    ...
    let t;
    switch (
      ("app-plus" === this._clientInfo.platform &&
